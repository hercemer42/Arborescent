...
- **Step configuration dialog**: Click a workflow step number to open a configuration dialog for that step. Currently shows step type selection; will be extended with additional per-step settings
