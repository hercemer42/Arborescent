...
- **Workflow disruption handling**: Running workflows pause gracefully when their terminal is closed, the item is moved or deleted, or the app restarts. Toast notifications explain what happened and items can be resumed from their current position
