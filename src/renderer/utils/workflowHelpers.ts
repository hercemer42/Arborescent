...
export type WorkflowExecutionEntry = { state: 'running' | 'awaiting-validation' | 'stuck'; terminalTabId: string; needsReview?: boolean; needsReviewNotified?: boolean; collaborating?: boolean; stopReceived?: boolean; clearing?: boolean };
