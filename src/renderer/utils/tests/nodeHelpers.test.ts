...
describe('getContextDeclarations', () => {
  const createContextNode = (id: string, content: string, metadata: Record<string, unknown> = {}): TreeNode => ({
    id,
    content,
    children: [],
    metadata,
  ...
  it('should return empty array when no context declarations exist', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', 'Task 1'),
      'node-2': createContextNode('node-2', 'Task 2'),
    };
  ...
  it('should find nodes marked as context declarations', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', 'Context A', { isContextDeclaration: true, blueprintIcon: 'star' }),
      'node-2': createContextNode('node-2', 'Task 2'),
    };
  ...
  it('should return multiple context declarations', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', 'Context A', { isContextDeclaration: true, blueprintIcon: 'star' }),
      'node-2': createContextNode('node-2', 'Task 2'),
      'node-3': createContextNode('node-3', 'Context B', { isContextDeclaration: true, blueprintIcon: 'flag' }),
    };
  ...
  it('should sort context declarations by content alphabetically', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', 'Zebra Context', { isContextDeclaration: true, blueprintIcon: 'star' }),
      'node-2': createContextNode('node-2', 'Apple Context', { isContextDeclaration: true, blueprintIcon: 'flag' }),
      'node-3': createContextNode('node-3', 'Middle Context', { isContextDeclaration: true, blueprintIcon: 'bell' }),
    };
  ...
  it('should use default icon "lightbulb" when blueprintIcon is not set', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', 'Context A', { isContextDeclaration: true }),
    };
  ...
  it('should use "Untitled context" when content is empty', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', '', { isContextDeclaration: true, blueprintIcon: 'star' }),
    };
  ...
  it('should not include nodes where isContextDeclaration is false', () => {
    const nodes: Record<string, TreeNode> = {
      'node-1': createContextNode('node-1', 'Context A', { isContextDeclaration: false }),
      'node-2': createContextNode('node-2', 'Context B', { isContextDeclaration: true, blueprintIcon: 'star' }),
    };
...
describe('shouldInheritBlueprint', () => {
  const createBlueprintNode = (id: string, metadata: Record<string, unknown> = {}): TreeNode => ({
    id,
    content: '',
    children: [],
    metadata,
  ...
  it('should return true when parent is a workflow node', () => {
    const nodes: Record<string, TreeNode> = {
      'workflow': createBlueprintNode('workflow', { isBlueprint: true, isWorkflow: true }),
    };
  ...
  it('should return false when parent is a regular node', () => {
    const nodes: Record<string, TreeNode> = {
      'regular': createBlueprintNode('regular'),
    };
  ...
  it('should return true when parent is a context declaration', () => {
    const nodes: Record<string, TreeNode> = {
      'context': createBlueprintNode('context', { isContextDeclaration: true }),
    };
