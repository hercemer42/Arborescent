...
describe('fileNaming utils', () => {
  describe('getNextUntitledNumber', () => {
    ...
    it('should return 2 when only untitled-1.arbo exists', () => {
      const paths = ['/path/to/untitled-1.arbo'];
      expect(getNextUntitledNumber(paths)).toBe(2);
    });

    it('should return max + 1 when multiple untitled files exist', () => {
      const paths = [
        '/path/to/untitled-1.arbo',
        '/path/to/untitled-3.arbo',
        '/path/to/untitled-2.arbo',
      ];
    ...
    it('should handle non-sequential numbers', () => {
      const paths = [
        '/path/to/untitled-1.arbo',
        '/path/to/untitled-5.arbo',
        '/path/to/untitled-10.arbo',
      ];
    ...
    it('should work with different path formats', () => {
      const paths = [
        'C:\\Users\\test\\untitled-1.arbo',
        '/home/user/untitled-2.arbo',
        'untitled-3.arbo',
      ];
      expect(getNextUntitledNumber(paths)).toBe(4);
    });
    ...
    it('should return 1 when files match pattern but have no valid numbers', () => {
      const paths = [
        '/path/to/untitled-.arbo',
        '/path/to/untitled-abc.arbo',
      ];
